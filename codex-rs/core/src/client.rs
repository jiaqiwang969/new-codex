...
#[cfg(test)]
use self::provider_support::anthropic_thinking_enabled_with_env;
use self::provider_support::build_reasoning_payload;
use self::provider_support::canonical_model_slug_for_provider;
use self::provider_support::sanitize_reasoning_effort_for_model;
use self::provider_support::supports_memory_trace_summarize;
use self::provider_support::validate_image_input_compat;
...
impl ModelClient {
    ...
    /// such as cached websocket reuse and sticky HTTP fallback across turns.
...
#[path = "client/provider_support.rs"]
