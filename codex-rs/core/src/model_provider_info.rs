...
impl ModelProviderInfo {
    ...
    pub fn create_gemini_provider() -> ModelProviderInfo {
        provider_inventory::create_gemini_provider()
    }

    pub fn create_grok_provider() -> ModelProviderInfo {
        provider_inventory::create_grok_provider()
    }

    pub fn create_antigravity_gemini_provider() -> ModelProviderInfo {
        provider_inventory::create_antigravity_gemini_provider()
    }

    pub fn create_antigravity_anthropic_provider() -> ModelProviderInfo {
        provider_inventory::create_antigravity_anthropic_provider()
    }

    pub fn create_anthropic_provider() -> ModelProviderInfo {
        provider_inventory::create_anthropic_provider()
    }

    pub fn create_gemma_provider() -> ModelProviderInfo {
        provider_inventory::create_gemma_provider()
    }
}
...
pub fn built_in_model_providers(
    ...
    provider_inventory::built_in_model_providers(openai_base_url)
}
